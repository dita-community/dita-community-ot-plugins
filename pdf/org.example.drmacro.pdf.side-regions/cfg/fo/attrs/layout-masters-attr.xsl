...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
  ...
  <xsl:attribute-set name="top-and-bottom-rules">
    <xsl:attribute name="border-bottom-width" select="'1pt'"/>
    <xsl:attribute name="border-bottom-color" select="'black'"/>
    <xsl:attribute name="border-bottom-style" select="'solid'"/>
    <xsl:attribute name="border-top-width" select="'1pt'"/>
    <xsl:attribute name="border-top-color" select="'black'"/>
